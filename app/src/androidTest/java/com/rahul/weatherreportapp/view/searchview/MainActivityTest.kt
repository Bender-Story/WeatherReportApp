...
class MainActivityTest {
    ...
    fun mainActivityTest() {
        ...
        val textView = onView(
            allOf(
                withText("Nothing to display, please start typing..."),
                childAtPosition(
                    childAtPosition(
        ...
        textView.check(matches(withText("Nothing to display, please start typing...")))

        val editText = onView(
            allOf(
                withId(R.id.searchEditText), withText("Please enter city name."),
                childAtPosition(
                    allOf(
                        withId(R.id.searchLayout),
                        childAtPosition(
        ...
        editText.check(matches(withText("Please enter city name.")))
    }
